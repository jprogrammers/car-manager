...
public class CartexDesignService {
    ...
    public static CartexDesign addCartexDesign(long userId, String information, String fileNumber, String economicCode, String city, String name1, String title1, String name2, String title2, byte[] image){

        CartexDesign cartexDesign = new CartexDesign(CounterService.increment(), userId, information, fileNumber, economicCode, city, name1, title1, name2, title2, image);
    ...
    public static CartexDesign editCartexDesign(long cartexDesignId, long userId, String information, String fileNumber, String economicCode, String city, String name1, String title1, String name2, String title2, byte[] image){

        CartexDesign cartexDesign = new CartexDesign(cartexDesignId, userId, information, fileNumber, economicCode, city, name1, title1, name2, title2, image);
        cartexDesignDao.save(cartexDesign);
