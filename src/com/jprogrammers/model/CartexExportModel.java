...
public class CartexExportModel {
    ...
    public CartexExportModel(String companyName, String registrationNumber, String companyInformation, String city, InputStream cartexImage,
                             ...
                             String cylinderCount, String wheelsCount, String cylinderSize, String country, String bodyNumber,
        ...
        setMarkingNumber(markingNumber);
    ...
    public String getCartexDate() {
        return cartexDate;
    }

    public void setCartexDate(String cartexDate) {
